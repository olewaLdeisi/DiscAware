...
from uneteval import eval_net
from unet import UNet
from unetutils import get_ids, split_ids, split_train_val, get_imgs_and_masks, batch
...
def train_net(net,
    ...
    dir_checkpoint = 'unetcheckpoints/'
